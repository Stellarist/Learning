...
void init(Scene& scene)
{
	...
	auto* floor_mesh = new Model(PROJECT_PATH "/assets/cornell/floor.obj", white);
	auto* shortbox_mesh = new Model(PROJECT_PATH "/assets/cornell/shortbox.obj", white);
	auto* tallbox_mesh = new Model(PROJECT_PATH "/assets/cornell/tallbox.obj", white);
	auto* left_mesh = new Model(PROJECT_PATH "/assets/cornell/left.obj", red);
	auto* right_mesh = new Model(PROJECT_PATH "/assets/cornell/right.obj", green);
	auto* light_mesh = new Model(PROJECT_PATH "/assets/cornell/light.obj", light);
